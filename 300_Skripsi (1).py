...
weights_path = '/home/muflih/tes/full_model_with_weights/VGG_VOC0712Plus_SSD_300x300_ft_iter_160000.h5'
...
def main(args,IDVideo):
    global counter_vehicleH, counter_vehicleH_menit, counter_vehicleR,objects_1, IDCentroid, jumlahkendaraan
    #home/muflih/coba_frame/kananbagus.mp4
    #rtsp://103.119.144.146/Pulo-Gadung-011-704487_3

    cap = cv2.VideoCapture('/home/muflih/coba_frame/{}.mp4'.format(args.video))
    ...
    while (cap.isOpened()):
        ...
        # object on the output frame
            ...
            cv2.line(frame,(centroid[0],centroid[1]),pt1_r,(0,255,255),3)
            cv2.line(frame,(centroid[0],centroid[1]),pt2_r,(0,255,255),3)
        ...
        if count%1800 == 0:
            ...
            print((sum(kec_menit)/len(kec_menit))/60*3.6)
            print(counter_vehicleH_menit)
            print()
            counter_vehicleH_menit = 0
            kec_menit = []
