...
class VideoAtribut():
	...
	def getGreenROI(self):
		...
		if self.IDVideo == 0:
			self.roi_H = np.array([(70,350),(580,140),(1660,230),(565,1080),(200,700)], np.int32)

		elif self.IDVideo == 1:
			self.roi_H = np.array([(0,415),(0,600),(1300,1080),(1450,410),(400,290)], np.int32)

		elif self.IDVideo == 2:
			self.roi_H = np.array([(1250,730),(90,480),(1100,200),(1370,350)], np.int32)

		elif self.IDVideo == 3:
			self.roi_H = np.array([(300,370),(700,200),(1630,150),(900,650)], np.int32)

		elif self.IDVideo == 4:
			self.roi_H = np.array([(0,300),(500,0),(1600,0),(740,850)], np.int32)
	...
	def getRedROI(self):
		...
		if self.IDVideo == 0:
			self.roi_R = np.array([(1100,160),(200,700),(870,1080),(1920,1080),(1920,280)], np.int32)

		elif self.IDVideo == 1:
			self.roi_R = np.array([(1350,650),(70,380),(980,130),(1450,150)], np.int32)

		elif self.IDVideo == 2:
			self.roi_R = np.array([(1330,380),(600,300),(0,480),(0,1080),(1100,1080)], np.int32)

		elif self.IDVideo == 3:
			self.roi_R = np.array([(1270,150),(700,550),(1920,1080),(1920,170)], np.int32)

		elif self.IDVideo == 4:
			self.roi_R = np.array([(985,0),(300,550),(1200,1080),(1920,1080),(1920,0)], np.int32)
